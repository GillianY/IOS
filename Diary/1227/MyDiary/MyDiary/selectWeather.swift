...
class selectWeather: UIViewController ,NSURLSessionDelegate, NSURLSessionDownloadDelegate,UITableViewDelegate,UITableViewDataSource {
    ...
    func tableView(tableView: UITableView, didSelectRowAtIndexPath indexPath: NSIndexPath) {
        ...
        var chooseIconImage =  UIImage(named:selectWeather.weatherIconName[indexPath.row]);
        chooseWeather.image =  chooseIconImage
        //from
        OriginalView.weatherBtn.tag = indexPath.row;
        OriginalView.weatherBtn.imageView?.image = chooseIconImage;
